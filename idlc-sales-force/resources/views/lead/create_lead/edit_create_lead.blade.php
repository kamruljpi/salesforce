					...
					<form action="{{route('update_create_lead')}}/{{$valueslead->id_create_lead}}" method="POST">
						...
						<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group add_input{{ $errors->has('area') ? ' has-error' : ''}}">
									...
									<div class="col-sm-12">
										<input type="text" class="form-control" name="area" value="{{$valueslead->area}}" placeholder="Area" id="area">
						...
						<div class="row">
								...
								<div class="form-group add_input">
									...
									<div class="col-sm-12">
										<select class="form-control" name="interest_label">
											...
											<option <?php echo $object->valueCheck($valueslead->interest_label,'might_invest')?> value="might_invest"> Might Invest</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'not_interested')?> value="not_interested"> Not Interested</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'unassigned')?> value="unassigned"> Unassigned</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'converted')?> value="converted"> Converted</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'pitched')?> value="pitched"> Pitched</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'open_for_all')?> value="open_for_all"> Open</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label,'assign_sales_agent')?> value="assign_sales_agent"> Assigned</option>
											<option <?php echo $object->valueCheck($valueslead->interest_label, 'not_updated')?> value=""> Not Assigned</option>
							...
							<div class="col-sm-4 ifa_hide_field hidden">
								<div class="form-group add_input{{ $errors->has('lead_assign') ? '  has-error' : ''}}">
									<label class="col-sm-8 control-label ">
										<span class="pull-left ">Select Area<span style="color: red;">*</span></span>
									</label>
									<div class="col-sm-12">
						...
						<div class="form-group add_input">
							<div class="col-sm-2 col-sm-offset-10">
								<button type="submit" class="btn btn-primary" style="margin-right: 15px;" id="updateLeadpopup">Update
								</button>
							</div>
						</div>
					</form>
