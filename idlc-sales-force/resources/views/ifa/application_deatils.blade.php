                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="mobile_no">Mobile No.  </label>
                                            <input type="text" readonly value="+88 {{ !isset($application_details->mobile_no) ?: $application_details->mobile_no  }}" class="form-control" >
                                    </div>
                                </div>
                                <div class="col-sm-6 ">
    ...
    @if($application_details->application_status == 'Submitted')
        ...
        <div class="panel-body">
            ...
            <div class="form-group" style="width: 100%; float: left;">
                ...
                <a href="{{ route('applicant_nid_validate_action', [$application_details->application_no, 'InValid'] ) }}" style="float: right; width: 25%; margin-right: 5%;" class="btn btn-danger">Reject</a>
            </div>
...
@elseif($application_details->application_status == 'PartiallyCompleted') 
    <div class="alert alert-warning" role="alert" style="margin-bottom: 0px; background:#fff3cd; color:#856404; width: 100%;font-weight: bold;font-size: 18px;">
      The Application is {{ $application_details->application_status }}.
    </div>
@elseif($application_details->application_status == 'Rejected') 
