...
@section('page_heading','Update New Rating')
@section('section')
		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-default add_body">
				<div class="panel-body">
					...
					<form action="{{route('update_new_rating')}}/{{$value->id_rating}}" method="POST">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
							...
							<div class="form-group add_input{{ $errors->has('lead_completed_number') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="lead_completed_number" value="{{ $value->lead_completed_number }}" placeholder="No of Lead Completed">
							...
							<div class="form-group add_input{{ $errors->has('rating') ? ' has-error' : ''}}">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="rating" value="{{ $value->rating  }}" placeholder="Rating">
