...
namespace App\Http\Controllers\ManagementSetting\Thana;
...
class ThanaController extends Controller
{
    ...
    public function index(){
        $thanaDetails = DB::table('tbl_bangladesh_thanas as tbtn')
                            ...
                            ->paginate(15);
        return view('management_setting.thana.index',compact('thanaDetails'));
    }
    ...
    public function create(){
        $divisionDetails = DB::table('tbl_bangladesh_divisions')
                            ...
                            ->where('is_deleted',0)
                            ->get();
        return view('management_setting.thana.create',compact('divisionDetails'));
    }
    ...
    {   
        ...
        $findThana = DB::table('tbl_bangladesh_thanas as tbtn')
                            ...
                            ->get();
        return view('management_setting.thana.edit',compact('findThana','divisionDetails'));
    }
